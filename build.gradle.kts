...
dependencies {
    ...
    integrationTestImplementation(libs.aws.sdk.kotlin.sqs)
...
mavenPublishing {
    pom {
        ...
        scm {
            url.set("https://github.com/christoph-sens/snsoverflow")
            connection.set("scm:git:git://github.com/christoph-sens/snsoverflow.git")
            developerConnection.set("scm:git:ssh://git@github.com/christoph-sens/snsoverflow.git")
        }
    }
